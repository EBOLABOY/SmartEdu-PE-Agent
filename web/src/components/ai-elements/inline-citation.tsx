...
function getSourceHost(source: string | undefined) {
  if (!source) {
    return "unknown";
  }
...
export const InlineCitationCarouselPrev = ({ className, ...props }: InlineCitationCarouselPrevProps) => {
  ...
  return (
    <button aria-label="上一条来源" className={cn("shrink-0", className)} onClick={handleClick} type="button" {...props}>
...
export const InlineCitationCarouselNext = ({ className, ...props }: InlineCitationCarouselNextProps) => {
  ...
  return (
    <button aria-label="下一条来源" className={cn("shrink-0", className)} onClick={handleClick} type="button" {...props}>
