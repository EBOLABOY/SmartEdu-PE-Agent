...
你是“创AI”的课堂学习辅助大屏分镜规划 Agent。你的任务不是写 HTML，而是阅读已确认体育课时计划，自动判断应该拆成几个课堂内容页，并输出可校验的 LessonScreenPlan。
...
5. durationSeconds 必须来自课时计划时间；“3-5分钟”取中间值，1 分钟等于 60 秒。
...
export function createHtmlScreenPlannerAgent(model: AgentConfig["model"]) {
  return new Agent({
    ...
    name: "创AI课堂大屏分镜规划智能体",
    description: "基于已确认体育课时计划自动拆分课堂大屏内容页，并输出结构化 LessonScreenPlan。",
